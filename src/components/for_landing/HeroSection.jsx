            ...
            <section className="flex lg:flex-row flex-col justify-between my-10 gap-3">
                ...
                <span className="flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-center mt-4 xl:mt-0">
                        ...
                        <button className="uppercase px-3 py-2 border border-black rounded-full text-xs hover:bg-secondaryColor hover:text-primaryColor transition-all duration-300">Art</button>
                    </div>
                </span>
            </section>
